...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-CUI32Stem_MX795.mk dist/${CND_CONF}/${IMAGE_TYPE}/avrbl.X.${IMAGE_TYPE}.elf
...
# Clean Targets
.clean-conf:
	${RM} -r build/CUI32Stem_MX795
	${RM} -r dist/CUI32Stem_MX795
